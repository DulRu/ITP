...
public class CVegiables extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(quantity, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 200, 90, 30));
        ...
        jPanel4Layout.setVerticalGroup(
            jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(foodName, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 26, Short.MAX_VALUE)
        );

        jPanel1.add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 140, 90, 30));
...
//        jLabel5.setText(null);
    ...
    private void GetMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_GetMouseClicked
        ...
        double select_quan = Double.parseDouble(jTable1.getValueAt(r,1).toString());
        
        double  v1 = Double.parseDouble(v_quan1);
        ...
        else if(select_quan<v1)
        {       
            showMessageDialog(null,"Required amount not available");
            quantity.setText(null);
        }
        
        else{
                boolean status = DBaccess.getfood(v_id, v_quan1);
